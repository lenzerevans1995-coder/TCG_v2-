    ...
    public class BoardCard : MonoBehaviour
    {
        ...
        private void UpdateAbilities()
        {
            ...
            if (selected && card.player_id == player.player_id)
            {
                ...
                {
                    if (iability != null && string.IsNullOrEmpty(iability.title))
                        continue; // CCG-EDIT: untitled system abilities (ccg_pitch) get no button — was the blank teal rectangle
                ...
                if (equip != null)
                {
                    ...
                    {
                        if (iability != null && string.IsNullOrEmpty(iability.title))
                            continue; // CCG-EDIT: untitled system abilities get no button
                        if (iability != null && iability.trigger == AbilityTrigger.Activate)
                        {
                            if (index < buttons.Length)
                            {
