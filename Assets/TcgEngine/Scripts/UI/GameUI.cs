...
namespace TcgEngine.UI
{
    ...
    public class GameUI : MonoBehaviour
    {
        ...
        public static bool IsOverUI()
        {
            ...
            Vector3 mouse_pos = MouseInput.GetMousePosition();
            eventDataCurrentPosition.position = new Vector2(mouse_pos.x, mouse_pos.y);
        ...
        public static bool IsOverRectTransform(Canvas canvas, RectTransform rect)
        {
            ...
            pevent.position = MouseInput.GetMousePosition();
